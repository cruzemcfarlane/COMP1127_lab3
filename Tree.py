...
tree_ex = makeTree ('/' ,makeTree ('+',makeTree(40,make_empty_tree(), make_empty_tree()),makeTree(5,make_empty_tree(), make_empty_tree())),makeTree('*', makeTree(3,make_empty_tree(),make_empty_tree()),makeTree('-',makeTree(7,make_empty_tree(),make_empty_tree()),makeTree(2,make_empty_tree(),make_empty_tree()))))
